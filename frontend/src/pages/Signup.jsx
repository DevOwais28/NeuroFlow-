...
import { signInWithEmailAndPassword, sendEmailVerification, signInWithPopup, GoogleAuthProvider, onAuthStateChanged } from "firebase/auth";
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    try {
      // Step 1: Call backend to create user (backend saves to Firestore)
      ...
      // Step 2: Sign in client-side to get Firebase auth session
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      // Step 3: Backend confirmed - allow access
      ...
      <div style={{ width: "100%", maxWidth: 420, position: "relative", zIndex: 1 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "0.95rem", color: "var(--text-secondary)", textAlign: "center", marginBottom: 40 }}>
            Start reducing your cognitive load today
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <button
              ...
              style={{
                ...
                color: "#03050f", background: "linear-gradient(135deg,#4DEEEA,#34D399)",
                boxShadow: "0 0 28px rgba(77,238,234,0.35)", cursor: loading ? "wait" : "pointer",
          ...
          {error && (
            <p style={{ fontSize: "0.85rem", color: "#ef4444", textAlign: "center", marginTop: 16 }}>
              {error}
            </p>
          )}
          ...
          <p style={{ fontSize: "0.9rem", color: "#64748b", textAlign: "center", marginTop: 28 }}>
            Already have an account?{" "}
            <Link to="/login" style={{ color: "#4DEEEA", textDecoration: "none", fontWeight: 600 }}>
              Log in
            </Link>
          </p>
        </div>
